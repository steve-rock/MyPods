...
#ifndef SWIFTYADS_SWIFT_H
#define SWIFTYADS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftyAds",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9SwiftyAds17AdmobNativeAdCell")
@interface AdmobNativeAdCell : UICollectionViewCell
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9SwiftyAds17AdmobNativeAdView")
@interface AdmobNativeAdView : GADNativeAdView
...
@interface AdmobOpenHandle (SWIFT_EXTENSION(SwiftyAds)) <GADFullScreenContentDelegate>
...
SWIFT_CLASS("_TtC9SwiftyAds20AppLovinNativeAdCell")
@interface AppLovinNativeAdCell : UICollectionViewCell
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9SwiftyAds25AppLovinNativeAdTableCell")
@interface AppLovinNativeAdTableCell : UITableViewCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9SwiftyAds20AppLovinNativeAdView")
@interface AppLovinNativeAdView : UIView
- (void)awakeFromNib;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ApplovinOpenHandle (SWIFT_EXTENSION(SwiftyAds)) <MAAdDelegate>
